            ...
            <div class="scroll-sidebar">
                ...
                <nav class="sidebar-nav">
                    <ul id="sidebarnav">
                        ...
                        <li> 
                            <a class="has-arrow waves-effect waves-dark" onclick="page('page/inicio.php')" aria-expanded="false"><i class="mdi mdi-gauge"></i><span class="hide-menu">DASHBOARD </span></a>
                        </li>
                        ...
                        <li> <a class="has-arrow waves-effect waves-dark" href="#" aria-expanded="false"><i class="mdi mdi-truck"></i><span class="hide-menu">DESPACHOS</span></a>
                            <ul aria-expanded="false" class="collapse">
                                <li><a onclick="page('page/list_desp.php')">Listado</a></li>
                            </ul>
                        </li>
